            ...
            var ExifReader = (function () {
                ...
                ExifReader.getOrientation = function (img_path, callback) {
                    if ((function (o1, o2) { if (o1 && o1.equals) {
                        ...
                        (function (target) { return (typeof target === 'function') ? target(0) : target.accept(0); })(callback);
                        return;
                    }
                    ExifReader.loadXHR(img_path, function (img) {
                        ...
                        reader.onload = function (e) {
                            ...
                            if (view.getUint16(0, false) !== 65496) {
                                (function (target) { return (typeof target === 'function') ? target(-2) : target.accept(-2); })(callback);
                                return null;
                            }
                            ...
                            var _loop_1 = function () {
                                ...
                                if (marker === 65505) {
                                    if (view.getUint32(offset += 2, false) !== 1165519206) {
                                        (function (target) { return (typeof target === 'function') ? target(-1) : target.accept(-1); })(callback);
                                        return { value: null };
                                    }
                                    ...
                                    var _loop_2 = function (i) {
                                        if (view.getUint16(offset + (i * 12), little_1) === 274) {
                                            (function (target) { return (typeof target === 'function') ? target((view.getUint16(offset + (i * 12) + 8, little_1) | 0)) : target.accept((view.getUint16(offset + (i * 12) + 8, little_1) | 0)); })(callback);
                                            return { value: null };
                                        }
                                    };
