    ...
    (function (digitalculture) {
        ...
        (function (config) {
            ...
            (function (Config) {
                ...
                PROJECT.VERSION = "0.6.2-beta-jswt";
                ...
                LUNA.COLUMN = 8;
                LUNA.ROW = 4;
                LUNA.FONT = "Arial, \'Microsoft JhengHei\', \'Heiti TC\'";
                LUNA.FLIP_TIME_OUT = 5000;
                LUNA.SYSTEM_LOGO_TIME_OUT = 7000;
                LUNA.SHOW_INTERVAL = 2500;
                LUNA.SHOW_STAY = 1500;
                ...
                (function (LUNA) {
                    ...
                    CARD.COLOR = "#121212";
                    CARD.FONT = "\'Times New Roman\', DFKai-sb, BiauKai";
                ...
                var DATA = (function () {
                    ...
                    DATA.FILETYPES_$LI$ = function () { if (DATA.FILETYPES == null)
                        DATA.FILETYPES = ["jpg", "png", "JPG", "PNG"]; return DATA.FILETYPES; };
                    ;
                    DATA.LIMIT = function () {
                ...
                (function (DATA) {
                    ...
                    TWDC.URL = "http://data.digitalculture.tw/taichung/oai?verb=ListRecords&metadataPrefix=oai_dc";
                    DATA.TWDC = TWDC;
